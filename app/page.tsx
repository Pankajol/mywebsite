          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600">Our platform allows users to easily upload and showcase their videos and images. Whether you are sharing memories, tutorials, or creative content, our app provides a simple and user-friendly interface to upload, manage, and display media. Perfect for creators looking to share their visual stories with the world.</p>
